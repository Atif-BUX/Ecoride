...
<main class="container py-5">
    <h1 class="text-center mb-4" style="color: #fff;">Bienvenue, <?php echo htmlspecialchars($firstname); ?> !</h1>
    <p class="text-center lead">Trouvez ou proposez votre prochain covoiturage.</p>

    <div class="text-center mb-5">
        <h1 class="display-4 fw-bolder mb-3" style="color: #fff;" id="slogan-animation">
            Voyagez <span style="color: var(--color-primary-dark);">Vert</span>, Voyagez Ensemble.
        </h1>
    ...
    <section class="mb-5">
        <h2 class="text-center mb-4" style="color: #fff;">Pourquoi EcoRide ?</h2>
    ...
    <section class="image-gallery py-4">
        <h2 class="text-center mb-4" style="color: #fff;">La Communauté EcoRide</h2>
        <div class="row g-4">
