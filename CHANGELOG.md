...
- Improved profile UI labels for credit transactions.
- Fixed PHP DB config for XAMPP (`DB_PORT=3306`, empty socket).

## [Unreleased]
- Driver UI for confirming pending reservations.
- Additional seed data for demo scenarios.
