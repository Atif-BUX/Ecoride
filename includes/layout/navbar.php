<?php
// Shared navigation header (no <head> / no DOCTYPE). Keeps the animated SVG logo intact.
if (session_status() !== PHP_SESSION_ACTIVE) { session_start(); }
$is_logged_in = isset($_SESSION['is_logged_in']) && $_SESSION['is_logged_in'] === true;
$roles = $_SESSION['user_roles'] ?? [];
$is_admin = in_array('ADMIN', array_map('strtoupper', $roles));
$is_employee = in_array('EMPLOYE', array_map('strtoupper', $roles));
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item"><a class="nav-link" href="pourquoi_ecoride.php">Pourquoi&nbsp;EcoRide&nbsp;?</a></li>
                    <?php if ($is_logged_in): ?>
                        <li class="nav-item"><a class="nav-link" href="proposer_trajet.php">Proposer</a></li>
                        <li class="nav-item"><a class="nav-link" href="profil.php">Profil</a></li>
                        <?php if ($is_employee): ?><li class="nav-item"><a class="nav-link" href="employe_reviews.php">Modération</a></li><?php endif; ?>
                        <?php if ($is_admin): ?><li class="nav-item"><a class="nav-link" href="admin_dashboard.php">Admin</a></li><li class="nav-item"><a class="nav-link" href="admin_params.php">Paramètres</a></li><?php endif; ?>
